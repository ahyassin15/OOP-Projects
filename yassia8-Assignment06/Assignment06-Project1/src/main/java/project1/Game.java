...
public class Game {
    ...
    public void startGameLoop() {
        ...
        //Game loop for up to 9 moves, which is the maximum number of moves allowed in the game for 3x3
        ...
        //If the maximum number of moves (9) is reached without a winner
        if (count == Math.pow(board.getGridSize(),2)) {
            System.out.println("Draw!"); //Print it's a draw
        }
    ...
    public static void main(String[] args) {
        ...
        boolean isValidChoice = false;  //Flag to ensure valid input for choice
